            ...
            <div className="p-4 lg:p-6 space-y-4 relative z-10 flex-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge className="bg-[#8b3d87] text-white text-[9px] px-1.5 font-mono rounded-full font-bold">MR-{activePatient.mrNumber}</Badge>
                    ...
                    <div className="flex items-center gap-2 text-[9px] font-bold text-slate-400 uppercase tracking-wider mt-0.5">
                      ...
                      <span>•</span>
                      <span className="text-[#8b3d87] font-bold">Consultation</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 max-w-4xl mx-auto">
                ...
                <div className="border border-slate-200 bg-white p-4 flex flex-col sm:flex-row items-center justify-between gap-3">
                  ...
                  <Button className="h-10 bg-[#8b3d87] hover:bg-[#722f6e] text-white font-bold uppercase tracking-wider px-6 rounded-none shadow-sm gap-2" disabled>
