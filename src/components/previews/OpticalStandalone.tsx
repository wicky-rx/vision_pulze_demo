...
import { 
  Glasses, Eye, CheckCircle2, ChevronDown, ClipboardList, Printer, Loader2,
            ...
            <div className="p-4 lg:p-6 space-y-4 relative z-10 flex-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-[9px] font-bold text-slate-400 uppercase tracking-wider mt-0.5">
                      ...
                      <span>•</span>
                      <span className="text-orange-600 font-bold">Dispensing Desk</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 max-w-4xl mx-auto">
                ...
                <div className="border border-slate-200 bg-white p-4 flex flex-col sm:flex-row justify-between items-center gap-3">
                  ...
                  <Button className="h-10 bg-orange-600 hover:bg-black text-white font-bold uppercase tracking-wider px-6 rounded-none shadow-sm w-full sm:w-auto gap-2" disabled>
